...
- [Backblaze B2](https://www.backblaze.com/cloud-storage) bucket
...
|-------------|------|-------------|
| `backblaze-b2` | `B2_KEY_ID`, `B2_APPLICATION_KEY` | B2 API credentials (used for bucket mount) |
...
2. **Backblaze B2**  - For audio storage (S3-compatible, generous free tier)
